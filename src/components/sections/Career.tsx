...
const careerTimeline = [
  {
    ...
    description:
      'Leading development of enterprise applications using React and .NET Core',
  },
  {
    id: 2,
    year: 'June 2019 - Nov 2023',
    company: 'Adapty Solutions',
    position: 'Software Developer',
    description:
      'Developed and maintained multiple ECommerce applications using .NET technologies.',
  },
  // {
  //   id: 3,
  //   year: '2019 - 2021',
